...
1. Line-up and wait: "[Callsign], runway {{RUNWAY}}, line up and wait."
2. Takeoff clearance: "[Callsign], runway {{RUNWAY}}, wind [dir] degrees [speed] knots, cleared for takeoff."
3. After airborne and climbing away: "[Callsign], contact departure on [departure frequency]."

## Arrival operations

1. Sequence traffic if needed: "[Callsign], number [n], [preceding traffic type] on [position]."
2. Landing clearance: "[Callsign], runway {{RUNWAY}}, wind [dir] degrees [speed] knots, cleared to land."
3. After touchdown: "[Callsign], vacate [direction] when able, contact ground on [ground frequency]."
...
When {{FLIGHT_PHASE}} is `takeoff` or `climb`, append: "Contact departure on [departure frequency]."
When {{FLIGHT_PHASE}} is `landing` and the aircraft has vacated, append: "Contact ground on [ground frequency]."
